MythTV Light RpiZero Debian & Ubuntu Packaging (.deb)
=============================================
...
The deb-light-rpizero build process caters for both methods and defaults to cmake.
...
- Place the contents of github MythTV/packaging/deb-light-rpizero repository into
  any directory.
- You can put the deb-light-rpizero directory on your
...
- To build the mythtv-light package, run the following. <dir1> is the place
  ...
  of packaging/deb-light-rpizero are located::
