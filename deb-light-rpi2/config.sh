        ...
        case $BUILD_METHOD in
            ...
            make)
                if [ "$arch" = "aarch64" ] || [ "$arch" = "arm64" ] ; then
                    ...
                    config_opt="--compile-type=release --disable-mmal --enable-libmp3lame --disable-vdpau --disable-v4l2 --disable-debug --enable-small \
                      --enable-opengl  \
                      --disable-vaapi \
		      --enable-neon \
                      --cpu=cortex-a7 --arch=armv7-a --extra-cflags=-mfpu=neon \
