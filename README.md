...
<code>
apt install git-core glslang-dev btop nmap screen vim sudo dh-exec ccache cmake \
...
<code>git clone --single-branch -b rpi4/fixes/36 https://github.com/peterngineering/mythtv-debian-light-armhf</code>

### Clone the mythtv upstream specific branch you want to build
## Make sure it matches the version above, eg. <rpi4/fixes/36> and <fixes/36>
...
<code>../../mythtv-debian-light-armhf/deb-light-rpi4/build_package.sh</code>
