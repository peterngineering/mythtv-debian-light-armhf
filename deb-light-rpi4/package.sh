...
case $projname in
    mythtv)
        packagename=mythtv-debian-light-rpi4_${source}${packagerel}_${arch}_$codename$strip
...
Package: mythtv-debian-light-rpi4
Version: $packagerel
Section: graphics
Priority: optional
Architecture: $arch
...
Description: MythTV Debian Light for Rpi4
...
FINISH
        ...
        ;;
    mythplugins)
        mythtvpackagename=mythtv-debian-light-rpi4_${source}${packagerel}_${arch}_$codename$strip
        packagename=mythplugins-debian-light-rpi4_${source}${packagerel}_${arch}_$codename$strip
        echo Package $packagename
        ...
        cat >$installdir/$packagename/DEBIAN/control <<FINISH
Package: mythplugins-debian-light-rpi4
Version: $packagerel
Section: graphics
Priority: optional
Architecture: $arch
...
Installed-Size: `du -B1024 -d0 $installdir/$packagename | cut  -f1`
Maintainer: P3te <na@none.net>
Depends: mythtv-debian-light-rpi4, perl, libimage-size-perl, perlmagick, libxml-parser-perl, libxml-sax-perl, libcarp-clan-perl, libsoap-lite-perl, libdate-manip-perl, libdate-calc-perl, libwww-perl, libxml-simple-perl, libdatetime-format-iso8601-perl, libjson-perl, libxml-xpath-perl, mjpegtools, dvdauthor, genisoimage, dvd+rw-tools,  python3-pil, python3-mysqldb, pmount, python3-feedparser, python3-pycurl
Conflicts: mythtv-common, mythtv-frontend, mythtv-backend, mythtv-light, mythtv-debian-light-rpi2
Homepage: http://www.mythtv.org
Description: MythTV Plugins Debian Light for Rpi4
